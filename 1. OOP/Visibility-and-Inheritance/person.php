...
class FlightDetails extends Flight {
    public function getDetails(Person $person) {
        ...
        return "Passenger: " . $person->fullName() . ", Airline: " . ucfirst($this->airline) . ", Flight Number: " . $this->flightNumber . ", From: " . ucfirst($this->departure) . " To: " . ucfirst($this->destination) . ", Gate: " . $this->gate . ", Seat: " . $this->seat;
